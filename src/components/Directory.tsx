...
export function Directory() {
  ...
  return (
    <section
      id="diretorio"
      className="relative z-10 border-t border-[var(--color-gold)]/45 py-12 md:py-20 px-6 sm:px-8 lg:px-12 bg-background/50 min-h-screen scroll-mt-20 overflow-hidden"
    >
